      ...
      <div className="mb-8">
        <p className="text-lg text-gray-600 max-w-3xl">
          {category?.description ||
            "Todo lo que necesitas para mantener tu jardín hermoso y saludable. Ofrecemos una amplia gama de herramientas, equipos y accesorios para el cuidado de espacios verdes."}
        </p>
      </div>
